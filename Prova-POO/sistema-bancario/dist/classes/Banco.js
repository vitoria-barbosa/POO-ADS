...
class Banco {
    ...
    transferir(numeroOrigem, numeroDestino, valor) {
        let contaOrigem = this.procurarConta(numeroOrigem);
        let contaDestino = this.procurarConta(numeroDestino);
    ...
    procurarCliente(CPFCliente) {
        return this._clientes.find((c) => c.cpf == CPFCliente);
    }
    procurarConta(numConta) {
        return this.contas.find((conta) => conta.numero == numConta);
    }
    associarContaCliente(numeroConta, cpfCliente) {
        let contaProcurada = this.procurarConta(numeroConta);
        let clienteProcurado = this.procurarCliente(cpfCliente);
        if (contaProcurada &&
            clienteProcurado &&
